...
Siguiendo recomendaciones comunes en la literatura sobre algoritmos genéticos, se evaluaron tres niveles de profundidad evolutiva: 300, 800 y 1300 generaciones. Estos valores representan una escala progresiva de exploración del espacio de búsqueda (baja, media y alta), y permiten estudiar la convergencia del algoritmo sin incurrir en tiempos de ejecución excesivos. Todas las ejecuciones conservaron la misma configuración base presentada en la Sección [FIGURA ACÁ].
