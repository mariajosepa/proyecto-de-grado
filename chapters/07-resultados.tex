...
La Tabla~\ref{tab:resumen-promedios} muestra los valores promedio obtenidos para cada métrica a partir de las 30 instancias simuladas.

\begin{table}[H]
\centering
\caption{Promedios generales por algoritmo (30 instancias).}
\label{tab:resumen-promedios}
\resizebox{\textwidth}{!}{%
...
\midrule
AG  & 29.53 & 6.47 & 157.37 & 703.17 & 30.10 \\
...
Ambos métodos ejecutan, en promedio, el mismo número de tareas. Sin embargo, el AG obtiene un makespan significativamente menor y logra un mejor balance entre operarios, lo cual sugiere que produce soluciones más estructuradas y eficientes.
