...
\textbf{Limitaciones.} El estudio utilizó instancias sintéticas (requeriría validación con datos históricos reales), horizonte limitado a un día laboral, número restringido de operarios (4-5) y duraciones determinísticas de tareas. A pesar de estas limitaciones, los hallazgos principales permanecen válidos.
